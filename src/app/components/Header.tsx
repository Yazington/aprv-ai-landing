...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="flex basis-3/12 items-center gap-8 p-6 m-2 md:p-2">
        <Image
          src="/logo2.png"
          alt="Brand Logo"
          width={140}
      ...
      <nav className="text-white flex flex-col sm:flex-row justify-center items-center  gap-8  m-2 p-2">
